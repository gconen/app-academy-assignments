...
describe Fixnum do
  ...
  it "reads negative" do
    -5.in_words.should == "negative five"
    -1_888_259_040_036.in_words.should == 'negative one trillion eight hundred eighty eight billion two hundred fifty nine million forty thousand thirty six'
    -32768.in_words.should == 'negative thirty two thousand seven hundred sixty eight'
  end
